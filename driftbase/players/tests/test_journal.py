...
class JournalTests(DriftBaseTestCase):
    ...
    def test_journal_gamestate(self):
        ...
        r = self.post(self.journal_url, [data], expected_status_code=httplib.CREATED)
    ...
    def test_journal_rollback(self):
        ...
        r = self.post(self.journal_url, [rollback_entry], expected_status_code=httplib.CREATED)
        journal_id = r.json()[0]["journal_id"]
        ...
        r = self.post(self.journal_url, [rollback_entry], expected_status_code=httplib.BAD_REQUEST)
        ...
        r = self.put(gamestate_url, data={"gamestate": json.dumps(gamestate_data),
                     "journal_id": journal_id}, expected_status_code=httplib.BAD_REQUEST)
    ...
    def test_journal_timestamp(self):
        ...
        r = self.post(self.journal_url, [entry], expected_status_code=httplib.CREATED)
